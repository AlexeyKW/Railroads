...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [245.539526, -4074.347389, 6988.258229, -378.294814], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [245.539526, -4074.347389, 6988.258229, -378.294814],
            units: 'degrees'})
    })
});
...
map.getView().fit([245.539526, -4074.347389, 6988.258229, -378.294814], map.getSize());
